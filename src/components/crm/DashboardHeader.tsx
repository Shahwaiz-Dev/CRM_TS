...
import { User, Bell, LogOut, Settings, HelpCircle, ClipboardList, Briefcase, Trash2, RefreshCw } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem, DropdownMenuSeparator } from '@/components/ui/dropdown-menu';
import { collection, getDocs, updateDoc, doc, onSnapshot, query, orderBy, limit, deleteDoc, where } from 'firebase/firestore';
    ...
    try {
      ...
      if (!userDoc.empty) {
        ...
        toast({
          ...
          description: "Could not find user data in database",
          variant: "destructive",
        });
      }
    } catch (error) {
      ...
      toast({
        title: "Error Refreshing Permissions",
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-64 p-0">
            ...
            >
              ...
              {refreshingPermissions ? 'Refreshing...' : 'Refresh Permissions'}
            </DropdownMenuItem>
            <DropdownMenuSeparator />
